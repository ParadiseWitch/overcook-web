/**
 * 测试对象：level-editor-renderer 辅助函数。
...
import * as levelEditorRenderer from "../level-editor-renderer";

describe("level-editor-renderer", () => {
  it("renders wall tiles with the wall texture", () => {
    expect(
      levelEditorRenderer.getFloorRenderSpec({
        type: "wall",
        x: 1,
        y: 2,
      }),
