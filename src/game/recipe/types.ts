...
// 辅助函数：创建食材定义
export function ingredientDef(type: string, cookStates: FoodState[] = []): IngredientDef {
...
// 类型守卫：判断是否为食材定义
export function isIngredientDef(def: FoodDef | IngredientDef): def is IngredientDef {
